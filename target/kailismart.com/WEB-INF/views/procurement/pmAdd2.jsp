...
<head>
    ...
    <style type="text/css">
        ...
        #myModal table {width:100%;table-layout:fixed;}
        #myModal td {white-space:nowrap;overflow:hidden;word-break:keep-all;text-overflow:ellipsis}
        ...
        .materName,.materModel{
            width:25%;
        }
        .materBrand{
            width:10%;
        }
        .edit,.materSumPrice,.remark{
            width:15%;
        }
    </style>
</head>
...
<div class="row">
                ...
                <div class="panel-body" id="pro">
                    ...
                    <div class="form-group col-lg-6">
                        <div class="dropdown iconic-input">
                            ...
                            <input type="hidden" name="company.ID" data-cid="" placeholder="供应单位">
                        </div>
                    </div>
                    <%--订单编号--%>
                    <div class="form-group col-lg-4">
                        <div class="iconic-input right">
                            ...
                            <input type="text" autocomplete="off" name="pmNumber" class="form-control"
                                   placeholder="订单编号"/>
                        </div>
                    </div>
                    <%--采购员--%>
                    <div class="form-group col-lg-2">
                        <div class="dropdown">
                            <input type="text" autocomplete="off" name="staff.name" class="form-control"
                                   data-toggle="dropdown" id="staff"
                    ...
                    <div class="form-group col-lg-6">
                        <div class="dropdown iconic-input left">
                            <i class="fa fa-book"></i>
                            <input type="text" autocomplete="off" class="form-control" id="contract"
                                   data-toggle="dropdown"
                                   placeholder="合同名称">
                    ...
                    <div class="form-group col-lg-8 remark" style="min-width:60%;">
    ...
    <%--材料集合--%>
    <div class="col-lg-12">
        <section class="panel" id="materlist-body" style="max-height:390px;height:390px;overflow:hidden;">
            <header class="panel-heading">
                材料列表
                ...
                <span style="margin-left:45.333333%;">合计：<span style="color:#333;" id="sumAll">0</span></span>
            </header>
            <div class="panel-body">
                <table class="table" id="materialList" style="max-height:440px !important;">
                    ...
                    <tr class="success">
                        ...
                        <th class="hidden-phone oper">已采购数量</th>
                        <th class="hidden-phone oper">到货日期</th>
                    </tr>
                    </thead>
                    <tbody id="maters">
                    <c:forEach items="${maters}" var="mater">
                        <tr>
                            <td style="">
                                <span class="label label-sm btn-success projects"
                                      data-project="${mater.apply.projectID}"
                                      data-price="" data-unit="${mater.unit.ID}"
                                      data-taxmoney="">${mater.name}
                                </span>
                            </td>
                            <td style="width: 150px; ">${mater.model}</td>
                            <td style="width: 50px; " title="${mater.brand}">${mater.brand}</td>
                            <td class="edit sum" style="width: 80px; ">
                                <span
                                        class="label label-warning label-mini mater-cid" id="${mater.ID}"
                                        data-apply-id="${mater.major}"
                                        data-apply="${mater.apply.ID}">${mater.sum}
                                </span>
                            </td>
                            <td class="edit planPrice" style="width: 80px; ">${mater.planPrice}</td>
                            <td style=""></td>
                            <td class="no_tax"></td>
                            <td style="" class="edit mater_remark"><span title="${mater.remark}">${mater.remark}</span></td>
                            <td style="">${mater.ySum}</td>
                            <td class="edit placeDate" style="width: 80px; "></td>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <%--表格搜索框--%>
                <div class="col-lg-4 pull-right" style="height:50px;margin-top: -13px;">
            ...
            <div class="modal-body">
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        <%--材料列表开始--%>
                        <div class="panel-body" style="margin-top: -30px;padding-top: 0px;">
                            <table id="material">
                                <thead>
                                <tr>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="applyTitle"></h4>
            </div>
            <div class="modal-body">
                &lt;%&ndash;材料列表&ndash;%&gt;
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <table id="material">
                                <thead>
                                <tr>
                                    &lt;%&ndash;<th class="project">材料名称</th>&ndash;%&gt;
                                    &lt;%&ndash;<th class="applyName">型号</th>&ndash;%&gt;
                                    &lt;%&ndash;<th class="hidden-phone date">品牌</th>&ndash;%&gt;
                                    &lt;%&ndash;<th class="hidden-phone personName">数量</th>&ndash;%&gt;
                                    &lt;%&ndash;<th class="hidden-phone personName no-wrap">单价</th>&ndash;%&gt;
                                    &lt;%&ndash;<th class="hidden-phone personName no-wrap">金额</th>&ndash;%&gt;
                                    &lt;%&ndash;<th class="hidden-phone personName no-wrap">价税合计</th>&ndash;%&gt;
                                    &lt;%&ndash;<th class="hidden-phone personName no-wrap">备注</th>&ndash;%&gt;
                                    &lt;%&ndash;<th class="hidden-phone oper">入库数量</th>&ndash;%&gt;
                                    &lt;%&ndash;<th class="hidden-phone oper">计划到货日期</th>&ndash;%&gt;
                                </tr>
                                </thead>
                                <tbody>
...
<script src="${basePath}/assets/js/isByApply.js"></script>
<!--页面所需脚本-->
