    ...
    <div class="col-sm-12">
        <section class="panel">
            <header class="panel-heading col-md-8">
                仓库管理/<span style="color:#65CEA7;">入库单集合</span>
...
<!-- 入库单详情Modal 摸态框 -->
<div class="modal fade bs-example-modal-sm" id="myModal" style="padding-left: 0px !important;" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-4 col-md-offset-4 col-sm-4 col-sm-offset-4 pull-right" style="height:53px;">
                        <textarea id="remark" name="remark" data-type="5" style="height: 100%;"
                    ...
                    <div class="col-md-4 col-md-offset-4 col-sm-4 col-sm-offset-4 pull-right" style="">
                        <input type="text" name="mixMoney" data-type="3" id="mixMoney" placeholder="运杂费"/>
                    </div>
                    <div class="col-md-4 col-md-offset-4 col-sm-4 col-sm-offset-4 pull-right" style="">
                        <input type="text" name="putDate" id="putDate" data-type="4" placeholder="入库日期"/>
                    </div>
                </div>
...
<script src="${basePath}/assets/js/putMaterial.js"></script>
</body>
</html>